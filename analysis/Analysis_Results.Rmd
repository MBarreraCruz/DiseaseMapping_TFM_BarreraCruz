...
tabla_grupos <- df_anova %>%
  ...
  mutate(
    ...
    grupo  = recode(grupo,
                    "Cruce_sexo" = "Mismo código (H/M)",
                    "Resto"      = "Resto de pares")
  ) %>%
  arrange(Modelo, grupo)

knitr::kable(tabla_grupos,
             col.names = c("Modelo", "Grupo", "Media", "SD", "n"),
             caption   = "Correlación media entre pares de enfermedades según grupo y modelo.")
```
